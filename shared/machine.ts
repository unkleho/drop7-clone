...
import { addDiscToGrid, DiscMap } from './drop7';
...
export const drop7Machine =
  ...
  createMachine(
    {
      context: { score: 0, level: 1, grid: [], discMap: {} },
      ...
      schema: {
        ...
        events: {} as
          ...
          | { type: 'RESTART' }
          | { type: 'COLLAPSE_DISCS' }
          | { type: 'COLLAPSE_TO_CHECK' }
          | { type: 'CHECK_GRID' }
          | { type: 'CHECK_LEVEL' }
          | { type: 'INCREMENT_LEVEL' }
          | { type: 'INCREMENT_TO_CHECK' }
          | { type: 'EXIT' }
